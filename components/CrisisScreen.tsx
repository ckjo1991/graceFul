...
export default function CrisisScreen({ onBack }: { onBack: () => void }) {
  return (
    <div className="mx-auto w-full max-w-md animate-in fade-in zoom-in text-center duration-500">
      <div className="rounded-3xl border-2 border-red-100 bg-white p-8 shadow-xl">
        ...
        <p className="mb-8 leading-relaxed text-slate-600">
          It sounds like you&apos;re carrying something very heavy. GraceFul
          cares about you, and we want to make sure you get real, immediate
          support.
        </p>
            ...
            <div className="flex items-center justify-between gap-4">
              <div>
                ...
                <p className="text-xl font-serif font-bold text-primary">
                  Dial {PHILIPPINE_RESOURCES.ncmh.hotline}
                </p>
              </div>
              <a
