...
const ALT_VIOLENT_INTENT_PATTERN =
  /\b(?:hope|wish|pray)\b[\s\S]{0,60}\b(?:him|her|them|someone|somebody|that\s+person|this\s+person|my\s+(?:dad|mom|mother|father|boss|sister|brother|friend|wife|husband|partner)|[A-Z][a-z]+(?:\s+[A-Z][a-z]+)?)\b[\s\S]{0,40}\b(?:die|dies|dead|gone|removed|erased|eliminated|taken)\b/i;
